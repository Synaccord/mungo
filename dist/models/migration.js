...
_defineProperty(Migration, "version", 2);

_defineProperty(Migration, "collection", 'mungo_migrations');

_defineProperty(Migration, "schema", {
  collection: {
    type: String,
    required: true
  },
  ...
  remove: Object,
  unset: new _schema["default"]({
    fields: [String],
    get: Object
  }),
  update: new _schema["default"]({
    get: Object,
    set: Object
  })
});
